...
This module provides a command-line interface to package the current repository into a Docker image
...
def main():
    ...
    """
    parser = argparse.ArgumentParser(description="Package the current repository into a Docker image and push to any registry.")
    parser.add_argument("--registry", required=True, help="Package registry URI (e.g., 'ghcr.io/JENO87/package-orchestrator', 'us-central1-docker.pkg.dev/your-project-id/ml-repo', or 'docker.io/your-username')")
