...
This module provides a command-line interface to package the current
repository into a Docker image and push it to any registry, focusing on
repos with sequential scripts.
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        required=True,
        help=(
            "Package registry URI (e.g., 'ghcr.io/JENO87/package-orchestrator', "
            "'us-central1-docker.pkg.dev/your-project-id/ml-repo', or 'docker.io/your-username')"
        ),
    )
    parser.add_argument(
