...
This file defines the Config dataclass to hold settings for packaging the current repository. It supports any registry
(e.g., GitHub Packages, GCP Artifact Registry, Docker Hub).
"""
